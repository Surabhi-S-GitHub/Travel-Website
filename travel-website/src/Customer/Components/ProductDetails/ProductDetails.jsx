      ...
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className='flex space-x-5 justify-center'>
              {product.images.map((item) => (
                <div className='aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[15rem] max-h-[5rem] mt-4'>
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 max-w-2xl px-4 pb-16 sm:px-16 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div>
              <h1 className="text-large font-semibold lg:text-xl text-gray-900 sm:text-3xl">Misa</h1>
              <h1 className="text-large lg:text-xl text-gray-900 opacity-60 pt-1">Shinigami</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  <Rating name="readonly" value={3.5} readOnly />
                  <p className='opacity-50 text-sm'>565540 Ratings</p>
                  <p className='ml-3 text-sm font-medium text-indigo-500 hover:text-indigo-400'>3700 Reviews</p>
                </div>
              </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-60'>5840 Ratings</p>
                </div>
